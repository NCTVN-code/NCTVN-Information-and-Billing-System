"""
Django settings for cable_info_billing project.
...
ROOT_URLCONF = 'cable_info_billing.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'subscriber.context_processors.notification_processor',
            ],
        },
    },
]

WSGI_APPLICATION = 'cable_info_billing.wsgi.application'
